 ...
 * Refer documentation {@linktourl https://logging.apache.org/log4j/2.0/manual/extending.html#PatternConverters}
 * <p>
 * Converters are required to provide a static newInstance method that accepts
 * an array of Strings as the only parameter.
 * <p>
 * Similar implementation in log4J package {@link org.apache.logging.log4j.core.pattern.ThreadNamePatternConverter}
 */
